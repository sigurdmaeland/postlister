...
# Full-dump av Bærum-ulovlighetsoppfølgingssaker fra portalen 2015-i dag (Acos
# Innsynpluss). Identisk oppsett som byggesak-scriptet (samme portal/API),
# bare med en annen Sakstype-filterverdi. "Ulovlighetsoppfølging" er Bærums
# offisielle navn på det plan- og bygningsloven kapittel 32 kaller
# ulovlighetsoppfølging - samme sakskategori som Kristiansands "ULOV".
#
# Modell A:
