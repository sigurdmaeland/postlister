...
# Full-dump av Bærum-ulovlighetsoppfølgingssaker fra den historiske portalen
# 2003-2015 (Acos Innsynpluss). Dette er et frossent arkiv – nyeste dokument
# er fra mars 2015, og portalen får aldri ny aktivitet (derfor ingen egen
# running_daily for den, akkurat som for byggesak-historikken).
#
# Modell A:
...
PORTAL_URL = BASE_URL + "/barum-gard-hist-03-15/sok-i-plan-og-byggesaker-fra-2003-2015/"

# Portal 2003-2015 (historisk)
PORTAL_ID = "102"
MENYPUNKT_ID = "1661"
SAKSTYPE = "at-ae6e937e__a279__4b7b__99c7__e38f9a93cfd6-UFO!kOJWCE"   # Ulovlighetsoppfølging
...
OUTPUT_FILE = HERE / "baerum_ulov.json"
...
def build_journalpost(doc_item):
    ...
    # NB: den historiske portalen publiserer ikke avsender/mottaker – begge blir
    # tomme her (både DocOnly og details mangler dataen for 2003-2015).
    return {
...
if __name__ == "__main__":
    import sys
    # Valgfrie argumenter (arkivet er frosset 2003-2015, "N dager tilbake" gir ikke mening her):
