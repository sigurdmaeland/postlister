...
# Full-dump av Trondheim-byggesaker fra Innsyn (GraphQL, 360 Plan & Build).
#
# API-et støtter ikke offset-paginering (load-more-queryene feiler alltid,
# uansett argumenter), og "Date"-feltene godtar kun yyyy-mm-dd. Løsning: hent
# dag-for-dag med eneste queryen som faktisk fungerer (SearchPostJournal, maks
# limit=100/felt) fra 2017-03-24 (eldste sak i portalen) og til i dag. De
# fleste dager er godt under 100 saker/journalposter; noen få dager over
# grensen fylles etter med et departement-filter (hjelper mest for
# journalposter), ellers logges en ADVARSEL.

BASE_URL = "https://trondheim.innsynsportal.no"
API_URL = f"{BASE_URL}/graphql"
LIST_ID = "fc010204-2c07-4f3c-a8ef-879ec218111c"       # byggesak-postliste
BYGG_TYPE_ID = "2de3bd79-704d-4738-8b05-5c7257623420"  # Byggesak-type UUID
...
START_DATE = date(2017, 3, 24)   # eldste byggesak funnet i portalen (BYGG-17/80001)
...
OUTPUT_FILE = HERE / "trondheim.json"
...
if __name__ == "__main__":
    import sys
    # Valgfrie argumenter:
    #   python3 main.py                        -> full dump fra 2017-03-24
