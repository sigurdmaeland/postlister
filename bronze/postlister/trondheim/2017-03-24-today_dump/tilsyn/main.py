...
# Full-dump av Trondheim-tilsynssaker fra Innsyn (GraphQL, samme plattform som
# ../bygg/main.py).
#
# Egen GraphQL-type ("Tilsynssak", type-id under) - ingen heuristikk trengs,
# i motsetning til Asker (som ikke har noen egen Tilsyn-sakstype - "Tilsyn"
# er der kun et avdelingsnavn). Funnet ved fritekstsøk (proceedingsWhere med
# feltet "search", som viste seg lovlig selv om det ikke er dokumentert i
# schema-et) etter "tilsyn": 97 av 100 treff var av typen "Tilsynssak" med
# eget sekvensnummer-prefiks "TILSYN-" (resten var ulovlighetssak/Henvendelse-
# saker som nevner "tilsyn" i beskrivelsen). Bekreftet ved eksakt
# typeIdIn-filter: 808 saker totalt, eldste fra 2017-05-03.
#
# Denne mappa dekker KUN Tilsynssak-typen, på samme måte som ../bygg/main.py
# kun dekker Byggesak, ../ulov/main.py kun ulovlighetssak og ../henv/main.py
# kun Henvendelse - egen mappe+fil per sakstype, som i Asker/Bergen.
#
# VIKTIG BUG i dette API-et (samme som bekreftet for ../bygg/main.py, ../ulov,
# ../henv, Asker og Drammen): "proceedings"-spørringens dato-filter
# (fromDate/toDate) beregner totalCount riktig for det spurte vinduet, men
# nodes-lista inneholder likevel saker fra andre datoer. De første nodene i
# lista treffer likevel korrekt for det spurte vinduet før den "lekker"
# utover - siden dag-for-dag-metoden (samme som ../bygg/main.py) går gjennom
# HVER dag i hele perioden, blir hver sak uansett fanget opp korrekt på sin
# egentlige dag, og eventuell "lekkasje" fra andre dager gir bare ufarlige
# duplikater (de dedupliseres på sak-id).
#
# Eldste tilsynssak funnet i portalen: 2017-05-03 (BYGG-17/82748).
...
START_DATE = date(2017, 5, 3)   # eldste tilsynssak funnet i portalen (BYGG-17/82748)
...
OUTPUT_FILE = HERE / "trondheim_tilsyn.json"
...
if __name__ == "__main__":
    import sys
    # Valgfrie argumenter:
    #   python3 main.py                        -> full dump fra 2017-05-03
