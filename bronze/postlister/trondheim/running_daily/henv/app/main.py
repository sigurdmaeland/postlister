...
# Daglig endringslogg for Trondheim-henvendelser (GraphQL, samme plattform som
# ../../bygg/app/main.py).
#
# Egen GraphQL-type ("Henvendelse", type-id under) - ingen heuristikk trengs,
# i motsetning til Asker sin henv-mappe. Se
# ../../../2017-03-24-today_dump/henv/main.py for detaljerte notater om
# sakstype-kartleggingen og den kjente dato-filter-buggen.
#
...
def write_output(nye_saker, nye_journalposter, ref_date):
    ...
    # TODO: last opp som .jsonl.gz til Azure (bronze/trondheim/load_type=incremental/date=<ref>/henv/)
