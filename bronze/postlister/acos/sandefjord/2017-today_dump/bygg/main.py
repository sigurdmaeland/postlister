"""Byggesaker (Sandefjord fra 2017-nå) - engangs historisk dump.

Se common/scraper_lib.py for bakgrunn - denne filen er bare
konfigurasjon + inngangspunkt. MED vedlegg (denne datakilden er den eneste
av de fem hos Sandefjord som har vedleggene offentlig nedlastbare).

Kjøremåter:
  python3 main.py                        -> hele arkivet (2017 til i dag)
...
KILDE = "bygg_ny"
OUTPUT_FILE = Path(__file__).parent / "sandefjord_bygg.json"
