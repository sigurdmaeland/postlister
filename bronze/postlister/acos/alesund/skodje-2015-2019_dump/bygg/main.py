"""Byggesaker (tidligere Skodje kommune, 2015-2019) - engangs historisk dump.

Lukket arkiv fra før sammenslåingen med Ålesund 01.01.2020 - INGEN
running_daily (arkivet får aldri nye saker). Ingen gateadresse forekommer i
dette arkivet (kun søkjar-/eigarnamn i tittelen) - se
../../common/scraper_lib.py sin modul-docstring.
...
KILDE = "skodje_hist"
OUTPUT_FILE = Path(__file__).parent / "skodje_bygg.json"
