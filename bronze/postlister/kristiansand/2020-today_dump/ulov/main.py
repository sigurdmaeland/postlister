"""Ulovlighetssaker (Kristiansand) - engangs historisk dump.

All faktisk skrape- og ryddelogikk bor i det delte biblioteket
kristiansand/common/scraper_lib.py (deles med bygg/henv/tilsyn, og med
...
OUTPUT_FILE = Path(__file__).parent / "kristiansand_ulov.json"
