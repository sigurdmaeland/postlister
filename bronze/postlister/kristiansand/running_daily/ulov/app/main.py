"""Ulovlighetssaker (Kristiansand) - daglig endringslogg.
...
biblioteket kristiansand/common/scraper_lib.py (deles med bygg/henv/tilsyn,
og med 2020-today_dump) - denne filen er bare konfigurasjon + inngangspunkt.
"""
import sys
