"""Byggesaker (Sarpsborg) - engangs historisk dump.

All faktisk skrape- og ryddelogikk bor i det delte biblioteket
sarpsborg/common/scraper_lib.py (deles med running_daily) - denne filen er
bare konfigurasjon + inngangspunkt. Portalen har data fra ca. 05.10.2023
(eldste observerte saksnummer er BYGG-23/00008).
"""
import sys
...
OUTPUT_FILE = Path(__file__).parent / "sarpsborg.json"
