"""Byggesaker (Sarpsborg) - daglig endringslogg.

Sarpsborgs OpenGov-portal har ingen datoer, API eller feed, så vi kan ikke
spørre "hva er endret siste døgn" slik Bergen/Stavanger gjør. I stedet
gjøres et fullt sveip av ALLE byggesakene hver dag, og resultatet diffes mot
...
sarpsborg/common/scraper_lib.py (deles med 2023-today_dump) - denne filen
