"""Byggesaker (Sandnes) - engangs historisk dump.

All faktisk skrape- og ryddelogikk bor i det delte biblioteket
sandnes/common/scraper_lib.py (deles med ulov/henv, og med running_daily) -
...
OUTPUT_FILE = Path(__file__).parent / "sandnes.json"
