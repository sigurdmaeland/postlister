"""Tilsynssaker (Sandnes) - engangs historisk dump.

All faktisk skrape- og ryddelogikk bor i det delte biblioteket
sandnes/common/scraper_lib.py (deles med bygg/ulov/henv, og med
...
OUTPUT_FILE = Path(__file__).parent / "sandnes_tilsyn.json"
