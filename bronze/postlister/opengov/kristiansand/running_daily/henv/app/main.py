"""Henvendelseer (Kristiansand) - daglig endringslogg (wheel-pakket).
...
gjøres et fullt sveip av ALLE henvendelsene hver dag, og resultatet
...
../../common/scraper_lib.py (delt med bygg/ulov/tilsyn, og med 2020-today_dump -
...
krever at `app` importeres som pakke):
    ...
    cd bronze/postlister/opengov/kristiansand/running_daily/henv
