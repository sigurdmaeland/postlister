"""Byggesaker (Kristiansand) - daglig endringslogg (wheel-pakket).
...
gjøres et fullt sveip av ALLE byggesakene hver dag, og resultatet
...
../../common/scraper_lib.py (delt med henv/ulov/tilsyn, og med 2020-today_dump -
