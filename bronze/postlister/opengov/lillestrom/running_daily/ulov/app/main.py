"""Ulovlighetssaker (Lillestrøm) - daglig endringslogg.

Lillestrøm sin OpenGov-portal har ingen datoer, API eller feed, så vi kan
...
diffes mot gårsdagens snapshot av journalpost-ID-er - selve mekanikken
(full_sweep, snapshot, diff, endringslogg, Azure-hook) bor i det delte
biblioteket lillestrom/common/scraper_lib.py (deles med bygg/henv/tilsyn, og
med 2020-today_dump) - denne filen er bare konfigurasjon + inngangspunkt.
"""
import sys
