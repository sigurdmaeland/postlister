"""Henvendelser (Lillestrøm) - daglig endringslogg.
...
gjøres et fullt sveip av ALLE henvendelsene hver dag, og resultatet diffes
mot gårsdagens snapshot av journalpost-ID-er - selve mekanikken (full_sweep,
snapshot, diff, endringslogg, Azure-hook) bor i det delte biblioteket
lillestrom/common/scraper_lib.py (deles med bygg/ulov/tilsyn, og med
