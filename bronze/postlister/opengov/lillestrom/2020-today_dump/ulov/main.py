"""Ulovlighetssaker (Lillestrøm) - engangs historisk dump.

All faktisk skrape- og ryddelogikk bor i det delte biblioteket
lillestrom/common/scraper_lib.py (deles med bygg/henv/tilsyn, og med
...
OUTPUT_FILE = Path(__file__).parent / "lillestrom_ulov.json"
