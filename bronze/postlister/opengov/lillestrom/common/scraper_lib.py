...
def address_from_tittel(tittel, kommune_nr):
    ...
    fallback når adresse-panelet på siden er tomt. To kjente formater: (1)
    ...
    "/", eller vises som kommunenr/gnr/bnr). Returnerer None for adresse
    hvis kandidaten ikke har et ekte husnummer til slutt."""
    if not tittel:
        return None, None
