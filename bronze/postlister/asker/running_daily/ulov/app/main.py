...
# Daglig endringslogg for Asker-ulovlighetssaker (samme Innsyn-plattform som
# Trondheim/Drammen).
#
# Denne mappa dekker KUN ULOV_TYPE_ID ("Ulovlighetsoppfølging"). Byggesaker
# (eByggesak) hentes av det egne scriptet i ../../bygg/app/main.py, på samme
# måte som Trondheim/Bergen skiller bygg/ulov/henv i egne mapper med egne
# filer i easy-pipelines. Askers portal har ingen egne "Henvendelsessak"-
# eller "Tilsyn"-typer å filtrere på.
#
...
# saksnummer-match. Se 2020-today_dump/ulov/main.py for detaljerte notater.
#
...
# seen_journalpost_ids.json (egen fil for ulov, separat fra bygg sin), i
# tilfelle saksbehandlere ikke alltid registrerer alt samme dag.
# Output-filnavnet er fortsatt datert på referansedagen (ref), så en evt.
# Azure-partisjonering (bronze/asker/load_type=incremental/date=<ref>/ulov/)
# er upåvirket.

BASE_URL = "https://asker-bygg.innsynsportal.no"
API_URL = f"{BASE_URL}/graphql"
LIST_ID = "d3aab42c-a204-438d-8e99-5189ae2ff468"       # byggesak-postliste (samme liste dekker ulov)
ULOV_TYPE_ID = "3ff64378-f8e8-4b32-b712-cf8e6d8b3a3b"  # "Ulovlighetsoppfølging"-type UUID
...
# Beskrivelse", f.eks. "338/90 Måltrostveien 19 - Mulig ulovlighet - Oppført
# bod og...". Kilden blander ofte inn ekstra ikke-adresse-info som gjør
# adressen usøkbar i eiendomsregisteret hvis den blir stående: parenteser med
# gammelt gnr/bnr eller gammelt navn ("(tidl. X)"), parsell-/leilighets-/
...
# ulovlighetssaker). extract_adresse() rydder bort alt dette og returnerer
# None i stedet for å gjette når ingenting reelt gjenstår. Kilden bruker
# begge separator-varianter (vanlig bindestrek "-" og tankestrek "–").
...
def write_output(saker, ref_date):
    ...
    # TODO: last opp som .jsonl.gz til Azure (bronze/asker/load_type=incremental/date=<ref>/ulov/)
