...
# Full-dump av Asker-ulovlighetssaker fra Innsyn (GraphQL, samme plattform som
...
# (eByggesak) hentes av det egne scriptet i ../bygg/main.py, på samme måte
# som Trondheim/Bergen skiller bygg/ulov/henv i egne mapper med egne filer
# i easy-pipelines. Askers portal har ingen egne "Henvendelsessak"- eller
# "Tilsyn"-typer å filtrere på (verifisert ved sampling av både nyeste og
# eldste saker uten typefilter - "Tilsyn" er kun et avdelingsnavn
# ("Tilsyn og ulovlighetsoppfølging"), ikke en egen sakstype).
#
...
START_DATE = date(2021, 6, 16)   # eldste ulovlighetssak funnet i portalen (21/2704)
...
OUTPUT_FILE = HERE / "asker_ulov.json"
...
if __name__ == "__main__":
    import sys
    # Valgfrie argumenter:
    #   python3 main.py                        -> full dump fra 2021-06-16
