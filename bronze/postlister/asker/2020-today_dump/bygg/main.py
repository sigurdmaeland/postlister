...
# Full-dump av Asker-byggesaker fra Innsyn (GraphQL, samme plattform som
...
# (Ulovlighetsoppfølging) hentes av det egne scriptet i ../ulov/main.py,
...
# "Henvendelsessak"- eller "Tilsyn"-typer å filtrere på (verifisert ved
# sampling av både nyeste og eldste saker uten typefilter - "Tilsyn" er kun
# et avdelingsnavn, ikke en egen sakstype).
#
