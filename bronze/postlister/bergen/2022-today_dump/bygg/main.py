...
# --- Lagre lokalt ---
# output_path = Path(__file__).parent / f"json_data/BYGG_bergen_postliste_2022-{date.today()}.json"
...
def to_azure_container(bronze_data, day_back_from_today=1, ACCOUNT_URL = 'https://storaggen2eaccountprod.blob.core.windows.net', AZURE_CONTAINER_NAME='postlister', DATA_PATH='bronze/bergen/load_type=full') -> None:
    ...
    if ACCOUNT_URL:
        try:
            ...
            blob_name = f"{DATA_PATH}/date={einnsyn_reference_date}/batch_bygg-2022-{einnsyn_reference_date}.jsonl.gz"
