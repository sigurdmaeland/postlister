"""Byggesaker (Oslo) - engangs historisk dump fra eInnsyn.

All faktisk skrape-/ryddelogikk bor i oslo/common/scraper_lib.py - denne
...
OUTPUT_FILE = HERE / "oslo_bygg.json"
CHECKPOINT_FILE = HERE / "oslo_bygg_checkpoint.jsonl"  # JSONL, én sak per linje - trygt å avbryte/gjenoppta

if __name__ == "__main__":
    from datetime import date, timedelta

    # python3 main.py                          -> full dump fra 2018
