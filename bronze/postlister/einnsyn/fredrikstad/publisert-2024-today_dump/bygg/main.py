"""Byggesaker (Fredrikstad) - engangs historisk dump fra eInnsyn.

All faktisk skrape-/ryddelogikk bor i fredrikstad/common/scraper_lib.py -
...
OUTPUT_FILE = HERE / "fredrikstad_bygg.json"
CHECKPOINT_FILE = HERE / "fredrikstad_bygg_checkpoint.jsonl"  # JSONL, én sak per linje - trygt å avbryte/gjenoppta

if __name__ == "__main__":
    from datetime import date, timedelta

    # python3 main.py                          -> full dump fra 2024-02-06
