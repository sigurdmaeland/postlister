"""Ulovlighetssaker (Trondheim) - engangs historisk dump.

All faktisk skrape-/ryddelogikk bor i trondheim/common/scraper_lib.py -
...
KILDE = "ulov"
OUTPUT_FILE = Path(__file__).parent / "trondheim_ulov.json"
