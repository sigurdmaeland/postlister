"""Byggesaker (Tromsø) - daglig endringslogg.

Se common/scraper_lib.py for bakgrunn om mekanismen (ekte datofelt, dato-
vindu WINDOW_DAYS - ingen snapshot trengs, samme mønster som Trondheim) -
...
if __name__ == "__main__":
    ...
    run_daily(OUTPUT_DIR, TYPE_IDS[SAKSTYPE], SAKSTYPE, day_back=db)
